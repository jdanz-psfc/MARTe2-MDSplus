...
#ifndef NI6368DIO_M_H_
#define NI6368DIO_M_H_
...
#define MAX_NI6368_DEVICES 8
#define NI6368DIO_M_IN 1
#define NI6368DIO_M_SYNCH_IN 2
#define NI6368DIO_M_OUT 3
class NI6368DIO_M: public DataSourceI, public MessageI {
public:
...
//Used only if mode == NI6368DIO_M_SYNCH_IN
    uint32 time;
    uint32 counter;
    int32 boardFileDescriptor;
    float64 triggerTime;
    float64 period;
    static bool notYetReset;
