...
#ifndef DELAYEDSIMULINKWRAPPERGAM_H_
#define DELAYEDSIMULINKWRAPPERGAM_H_
 ...
 * 
 */
class DelayedSimulinkWrapperGAM: public GAM, public MessageI {
...
public:
     ...
     *   stepFunction = NULL
     */
    DelayedSimulinkWrapperGAM();

    /**
     * @brief Destructor. NOOP.
     */
    virtual ~DelayedSimulinkWrapperGAM();
...
protected:
    uint32 initCount;
    ConfigurationDatabase dataCopy;
...
#endif /* DELAYEDSIMULINKWRAPPERGAM_H_ */
